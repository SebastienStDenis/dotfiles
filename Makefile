...
link-claude: ## Link Claude CLAUDE.md, settings, statusline, hooks, agents, commands, and skills
	...
	@$(call backup_and_link,"$(CURDIR)/claude/statusline-command.sh","$(HOME)/.claude/statusline-command.sh")
